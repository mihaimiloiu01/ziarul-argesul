...
/// AricleDetailsScreen class represents the visual implementation of a
/// deserialized ArticleModel.
...
class _ArticleDetailsScreenState extends State<ArticleDetailsScreen> {
  ...
  void initState() {
    ...
    bottomBanner = BannerAd(
        ...
        listener: BannerAdListener(
            onAdLoaded: (Ad ad) {
              print('News page: Bottom banner loaded');
            },
            onAdFailedToLoad: (Ad ad, LoadAdError error) {
              print('News page: Bottom banner failed to load');
            }
        ),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      /// Edit the topbar of an opened article.
      appBar: AppBar(
        elevation: 0.0,
        ...
        leading: IconButton(
            ...
            /// On pressed, the back button of an article will not perform a refresh
            /// for the former page.
            onPressed: () {
